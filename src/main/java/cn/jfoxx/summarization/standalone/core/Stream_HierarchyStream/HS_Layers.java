...
public class HS_Layers {
    ...
    public void UpdateUpperSumZ(SumZ upper) {
        upper_sumZ = upper;
        UpdateU_f(Calculator.GetFeather(upper_sumZ));
    }
    ...
    public int DealOne(SumZ_Object o) {
        double gi = Calculator.GOOinF(o, U_f);// Gain of this object
    ...
    private int SwapEachOne(SumZ_Object o) {
        ...
        // the gain of sumZ
        double maxg = Calculator.GOSinF(sumZ, U_f);
        int maxid = -1;
        // traversal all sumZ
        for (int i = 0; i < lk; i++) {
            SumZ tsumZ = new SumZ();
            ...
            double g = Calculator.GOSinF(tsumZ, U_f);
    ...
    public SumZ_Object replace(int id, SumZ_Object o) {
        ...
        sumZ.Add(o);
        G_f = Calculator.GetFeather(sumZ);
        L_f = Calculator.FeatherWithoutF(U_f, G_f);
        return rm;
    }
